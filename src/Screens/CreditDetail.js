...
export default class CreditDetail extends Component{
    ...
    async UNSAFE_componentWillReceiveProps(nextProps){
        ...
        if(nextProps.user.dataUpdateInformation && nextProps.user.dataUpdateInformation !== user.dataUpdateInformation){
        ...
        //validatePassword
        if(nextProps.user.validateInformationError && nextProps.user.validateInformationError !== user.validateInformationError){
            if(nextProps.user.validateInformationError.data && nextProps.user.validateInformationError.data.message && nextProps.user.validateInformationError.data.message == "invalid_password"){
        ...
        if(nextProps.user.validateInformation && nextProps.user.validateInformation !== user.validateInformation){
                ...
                <ScrollView style={{flex:1}}> 
                    ...
                    <View style={styles.inner}>
                        ...
                        <View style={styles.benner}>
                            <Text style={{fontSize:22, color:'#02475e',fontFamily:'Battambang-Bold'}}>{I18n.t('EditAccount')}</Text>
                        </View>   
                        <View style={styles.btnBack}>
                    ...
                    <View style={styles.branch}
                        ...
                        <TextInput style={styles.ListTitleBox}
                    ...
                    <View style={styles.branch}
                        ...
                        <TextInput style={styles.ListTitleBox}
                            ...
                            onChangeText={(value) => this.handleChangeInput('bankAccountName', value)}
                        />
                        <View style={styles.iconBox}>
                            <Text style={styles.Date}>{I18n.t('ChangeBankAccountName')}</Text>
                        </View>
                    </View>
                    <View style={styles.branch}
                        ...
                        <TextInput style={styles.ListTitleBox}
                            ...
                            onChangeText={(value) => this.handleChangeInput('bankAccountNumber', value)}
                        />
                        <View style={styles.iconBox}>
                    ...
                    <TouchableOpacity style={styles.branch}
                        ...
                        <View style={styles.ListTitleBox}>
                            <Text style={styles.ListTitle} style={{color:"grey",
                                fontSize:20,
                                marginLeft:20,
                                fontWeight:'bold'
                                }}>************</Text>
                    ...
                    <TouchableOpacity style={styles.branch}
                        onPress={()=>{NavigationService.navigate(NAV_TYPES.CHANGEPHONE, {data:userStorage.phone})}}>
                        <View style={styles.ListTitleBox}>
                        {userStorage && userStorage.phone &&
                            <Text style={styles.ListTitle} style={{
                                color:"grey",
                                fontSize:14,
                                marginLeft:20,
                                fontWeight:'bold'
                            ...
                            <View style={{backgroundColor: 'rgba(0,0,0,0.5)',flex:1,justifyContent:'center'}}>
                                <View style={{backgroundColor:'#ffffff',margin:30,borderRadius:10,height:200,shadowColor: "#000",shadowOffset: {
                                    ...
                                    <View style={styles.HeaderTitle}>
                                        <Text style={styles.HeaderTitle} style={{fontSize:16,fontWeight:'bold',color:'black',}}>{I18n.t('confirmPassword')}</Text>
                                    </View>
