...
export default class ResultPackage extends Component {
    ...
    UNSAFE_componentWillReceiveProps(nextProps) {
        ...
        if (nextProps.user.searchPackageError && nextProps.user.searchPackageError !== user.searchPackageError) {
            // alert('Invalid package number work')
            Alert.alert(I18n.t('alertInvalidPackage'))
        }
        if (nextProps.user.searchPackage && nextProps.user.searchPackage !== user.searchPackage) {
            if (nextProps.user.searchPackage.length > 0) {
                NavigationService.navigate(NAV_TYPES.SPECAILINFO, { data: nextProps.user.searchPackage })
            } else {
                // alert('Invalid package number')
                            ...
                            <View style={styles.container}>
                                <View style={styles.inner}>
                                    ...
                                    <View style={styles.benner}>
                                        <Text style={styles.text}>{I18n.t('shippingTracking')} </Text>
                                    </View>
                                </View>
                                    ...
                                    {scanning ?
                                                ...
                                                <>
                                                    ...
                                                    <View style={styles.rectangleContainer}>
                                                        ...
                                                        <View style={styles.rectangle}>
                                                            {/* <View style={{height:130,width:130,borderColor:'white',
                                                        borderWidth:3,
                                                        borderRadius:5,
                                                        }}>
                                                    </View> */}
                                        ...
                                        <View style={styles.scaneBox}>
                                            ...
                                            <View style={styles.ScaneBoxTitle}>
                                                <Text style={styles.ScaneTitle}>{I18n.t('pleasClickOnTheImageAboveToScan')}</Text>
                                            </View>
                                            <View style={styles.qrCode}>
                                                <Text style={styles.qrCodeTitle}>{I18n.t('QR_Code')}</Text>
                                            </View>
                                        </View>
                                    }
                                </View>
